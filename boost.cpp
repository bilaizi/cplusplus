...
public:
    ...
    void do_receive() {
        socket_.async_receive_from(
            mutable_buffer{ data_, max_length },
            sender_endpoint_,
...
int main(int argc, char* argv[]){
    try {
        ...
        write(s, boost::asio::buffer(request, request_length));
        char reply[max_length];
        size_t reply_length = read(s, mutable_buffer{ reply, request_length });
        std::cout << "Reply is: ";
